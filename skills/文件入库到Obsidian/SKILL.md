...
`/Users/mac/Documents/Obsidian Vault/00-Inbox 收件箱`
...
- Copies qualifying files into `00-Inbox 收件箱/附件/YYYY-MM-DD/`.
- Creates or updates `00-Inbox 收件箱/YYYY-MM-DD-今日收件.md`.
